...
module "aws-load-balancer-controller-role" {
  source = "github.com/buildersbank/terraform-modules/aws/modules/iam_role"

  name        = "ALBIngressControllerRole"
  description = "Role for ALB Ingress Controller"

  managed_policy_arns = [module.aws-load-balancer-controller-policy.arn]
    ...
    Statement = [
      {
        ...
        "Condition" = {
          "StringEquals" = {
            "${var.oidc_provider}:sub" = "system:serviceaccount:${var.namespace}:alb-ingress-controller",
